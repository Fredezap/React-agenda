...
const TaskForm = ({add}) => {
    ...
    return (
        <form onSubmit={addTask} className='d-flex justify-content-center align-items-center addTaskForm'>
            <div className='form-outline flex-fill'>
                ...
                <button type='submit' className='btn btn-primary btn-lg ms-2 add-botton'>Add a new task</button>
            </div>
        </form>
    );
}
